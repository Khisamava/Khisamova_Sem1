...
File <string>:131, in new_game(event)

File <string>:75, in targetting(self, event)

File ~\miniconda3\lib\tkinter\__init__.py:2903, in Canvas.itemconfigure(self, tagOrId, cnf, **kw)
...
File ~\miniconda3\lib\tkinter\__init__.py:1636, in Misc._configure(self, cmd, cnf, kw)
